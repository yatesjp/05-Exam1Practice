...
def run_test_problem3a():
    ...
    # Window 4:
    title = 'Problem 3a. Test 5: Start at (60, 45), 11 lines'
    window3 = rg.RoseWindow(450, 300, title)

    # Test 5 (it is on window 3):
    point = rg.Point(60, 45)
    expected = 101
    answer = problem3a(window3, point, 11)
    print()
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)
...
def problem3a(window, point, n):
    ...
    for k in range(n):
        ...
        giraffe = rg.Line(point, endpoint)

        giraffe.thickness = 1 + 2 * k
        if giraffe.thickness > 13:
            giraffe.thickness = 13

        totalthick = totalthick + giraffe.thickness

        giraffe.attach_to(window)
...
def problem3b(m, point1):
    ...
    for k in range(m):
        superthick = superthick + problem3a(window3, point1, 3 + 2 * k)
